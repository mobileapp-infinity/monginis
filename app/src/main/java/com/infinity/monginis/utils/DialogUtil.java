...
public class DialogUtil {
    ...
    public static void showCityNotFoundDialog(Activity activity) {
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(activity);
                alertDialog.setMessage("We are not able to find your current city name,Please try again after some time!");
